...
describe("TamboV1Provider", () => {
    ...
    it("uses custom query client when provided", () => {
        ...
        const wrapper = ({ children }) => (React.createElement(TamboV1Provider, { apiKey: "test-api-key", queryClient: customClient }, children));
        const { result } = renderHook(() => useQueryClient(), { wrapper });
    ...
    it("registers components when provided", () => {
        ...
        const wrapper = ({ children }) => (React.createElement(TamboV1Provider, { apiKey: "test-api-key", components: components }, children));
        const { result } = renderHook(() => useTamboRegistry(), { wrapper });
    ...
    it("registers tools when provided", () => {
        ...
        const wrapper = ({ children }) => (React.createElement(TamboV1Provider, { apiKey: "test-api-key", tools: tools }, children));
        const { result } = renderHook(() => useTamboRegistry(), { wrapper });
    ...
    it("registers MCP servers when provided", () => {
        ...
        const wrapper = ({ children }) => (React.createElement(TamboV1Provider, { apiKey: "test-api-key", mcpServers: mcpServers }, children));
        const { result } = renderHook(() => useTamboRegistry(), { wrapper });
    ...
    it("provides onCallUnregisteredTool to registry", () => {
        ...
        const wrapper = ({ children }) => (React.createElement(TamboV1Provider, { apiKey: "test-api-key", onCallUnregisteredTool: onCallUnregisteredTool }, children));
        const { result } = renderHook(() => useTamboRegistry(), { wrapper });
