 ...
 * ```
 */
export declare function useTamboV1ThreadList(listOptions?: ThreadListOptions, queryOptions?: Omit<UseQueryOptions<ThreadListResponse>, "queryKey" | "queryFn">): import("@tanstack/react-query").UseQueryResult<ThreadListResponse, Error>;
//# sourceMappingURL=use-tambo-v1-thread-list.d.ts.map