...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      vendorFnPromise = (await import("./arktype-aI7TBD0R-YQLNCRUK.js")).default();
      break;
    case "effect":
      vendorFnPromise = (await import("./effect-QlVUlMFu-AJQMIARN.js")).default();
      break;
    case "sury":
      vendorFnPromise = (await import("./sury-CWZTCd75-7IEHZI6D.js")).default();
      break;
    case "typebox":
      vendorFnPromise = (await import("./typebox-Dei93FPO-REDUBEK2.js")).default();
      break;
    case "valibot":
      vendorFnPromise = (await import("./valibot--1zFm7rT-2BA4E4EY.js")).default();
      break;
    case "zod":
      vendorFnPromise = (await import("./zod-Bwrt9trS-UMGW3K67.js")).default();
      break;
    default:
...
//# sourceMappingURL=chunk-ZUMZDKTK.js.map
